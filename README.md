...
While the logs data is parsed and sent to the kibana dashboard where the parsed data can be used to present different type of analyzing tool and present the data
